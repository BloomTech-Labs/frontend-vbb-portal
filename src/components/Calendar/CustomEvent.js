...
export const customWeekViewEvent = data => {
    return (
        <div className='rbc-events-container'>
            <p className='resourceEvent assignedComputers'>Available computers: {data.event.availableComputers}/{data.event.unavailableComputers + data.event.availableComputers}</p>        
