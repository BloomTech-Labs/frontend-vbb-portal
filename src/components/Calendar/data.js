...
export const events = [
  {
    id: 0,
    title: 'Board meeting',
    start: new Date(Date.UTC(2021, 6, 13, 8, 0, 0)),
    end: new Date(Date.UTC(2021, 6, 13, 8, 30, 0)),
  ...
  },
  {
    id: 1,
    title: 'MS training',
    start: new Date(Date.UTC(2021, 6, 13, 12, 0, 0)),
    end: new Date(Date.UTC(2021, 6, 13, 12, 30, 0)),
  ...
  },
  {
    ...
    start: new Date(Date.UTC(2021, 6, 13, 23, 30, 0)),
    end: new Date(Date.UTC(2021, 6, 13, 23, 0, 0)),
    availableComputers: 8,
  ...
  },
  {
    ...
    start: new Date(Date.UTC(2021, 6, 13, 14, 0, 0)),
    end: new Date(Date.UTC(2021, 6, 13, 14, 30, 0)),
  ...
  },
  {
    id: 12,
    title: 'Dog Walking',
    start: new Date(Date.UTC(2021, 6, 13, 19, 0, 0)),
    end: new Date(Date.UTC(2021, 6, 13, 19, 30, 0)),
