...
export const events = [
  {
    id: 0,
    title: 'Board meeting',
    start: new Date(Date.UTC(2021, 5, 13, 8, 0, 0)),
    end: new Date(Date.UTC(2021, 5, 13, 8, 30, 0)),
  ...
  },
  {
    ...
    start: new Date(Date.UTC(2021, 6, 14, 1, 0, 0)),
    end: new Date(Date.UTC(2021, 6, 14, 1, 30, 0)),
    availableComputers: 8,
