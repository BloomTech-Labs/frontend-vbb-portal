...
class Booking extends React.Component {
  ...
  display_day = (day) => {
    switch(day){
      ...
      case 48: return("Wednesday");
      case 72: return("Thursday");
      case 96: return("Friday");
      case 120: return("Saturday");
      case 168: return("Sunday");
      default: return("--")
    }
  }
        ...
        <br />
        {
          ...
          <div>
            <input type="checkbox" id="commitment" name="commitment" 
              ...
              onChange={this.handleCommitChange}></input>
