...
def testFunction():
  ...
  g.email_send(
    "varun.raja@villagebookbuilders.org",        # personal email form form
    "Welcome to the VBB Family!",                
    "api\emails\\templates\\welcomeLetter.html",
    "api\emails\\templates\\test.html", 
    {
      '__first_name': "Shwetha",                 # first name from form
      '__email': "varunvraja@gmail.com",         # email generated by shweta's code
      '__password': "vbb"                        # password generated by shweta's code
    }
  )
  g.email_send(
    "varun.raja@villagebookbuilders.org",
    "Congratulations! You Signed Up for a New Mentoring Session",
    "api\emails\\templates\\sessionConfirm.html",
    "api\emails\\templates\\test.html",
    {
      '__sessiontime': "10:30 PM EST",
      '__dayofweek': "Monday",
      '__programname': "Mumbai",
      '__programdirector': "Sarthak"
    } 
  )
